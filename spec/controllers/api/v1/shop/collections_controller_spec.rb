...
RSpec.describe Api::V1::Shop::CollectionsController, type: :controller do
  ...
  describe "create" do
    it "should create shop_collection according to collection ids array" do
      expect {
          post :create, params: {collection: collection_attributes.merge(shop_id: @shop.id), shop_id: @shop.id, format: :json }
  ...
  describe "#update" do
    it "shoud update existed collection" do
      ...
      put :update, params: {collection: collection_attributes.merge(title: 'OK',shop_id: @shop.id),shop_id: @shop.id, id: collection.id, format: :json }
